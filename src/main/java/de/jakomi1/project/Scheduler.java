...
public final class Scheduler {
    ...
    private static boolean scheduleable(Location location) {
        if (!enabled()) {
    ...
    public static void runGlobalRegional(Runnable runnable) {
        runGlobal(runnable);
    }
    ...
    public static void runRegional(Runnable runnable, Location location) {
        runRegion(location, runnable);
    }
    ...
    public static void runEntityLater(Entity entity, Runnable runnable, long delayTicks) {
        if (!enabled() || entity == null || !entity.isValid()) return;
